      ...
      <form onSubmit={handleSubmit} className="relative z-10 w-full">
        ...
        >
          <div className="flex items-center gap-3">
            {/* Botón adjuntar (solo si hay handler) */}
            {onUploadFile ? (
              <>
                <input
                  ref={fileInputRef}
            ...
            <textarea
              ...
              className={[
                ...
                "bg-transparent",
                "px-4",
                // 👇 centra mejor el texto/placeholder en 44px
                "py-[11px] leading-5",
                // 👇 FIX light/dark: usa variables del tema
                "text-sm text-[color:var(--foreground)] placeholder:text-[color:var(--muted)] caret-[color:var(--foreground)]",
                "focus:outline-none",
                "min-h-[44px]",
              ].join(" ")}
